...
public class TelaDeExclusaoDeConta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Sistema IFBA - Tela de Exclusão de Conta");
        setResizable(false);

        lblTitulo.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        lblTitulo.setText("Exclusão de Conta");
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        try {
            ...
            contaDTO.setId(Integer.parseInt(txtId.getText()));

            new ContaDAO().excluir(contaDTO);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                if(!Y.t()){new TelaDeExclusaoDeConta().setVisible(true);}
            }
        });
    }
