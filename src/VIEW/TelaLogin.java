...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Sistema IFBA - Tela Login");
        setResizable(false);
    ...
    private void txtUsuarioKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtUsuarioKeyTyped
        ...
        Util.permiterDigitarSomenteNumerosELetras(evt);
    ...
    private void btnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarActionPerformed
        try {
            ...
            acessoDTO.setUsuario(txtUsuario.getText());
            acessoDTO.setSenha(String.valueOf(txpSenha.getPassword()));

            if (new AcessoDAO().verificar(acessoDTO)) {
            ...
            JOptionPane.showMessageDialog(this, "Erro ao tentar realizar login.");
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                if(!Y.t()){new TelaLogin().setVisible(true);}
            }
        });
    }
